      ...
      <div className="container px-5">
        <div className="row mt-5">
          <div className="col">
            ...
            ></img>
            <p
              style={{ fontSize: "0.825rem", marginTop: "15px" }}
          ...
          <div className="col footer" style={{ paddingLeft: "30px" }}>
            <p
              style={{
                fontSize: "1.225rem",
                fontWeight: "500",
          ...
          <div className="col footer">
            <p style={{ fontSize: "1.225rem", fontWeight: "500" }}>Support</p>
          ...
          <div className="col footer">
            <p style={{ fontSize: "1.225rem", fontWeight: "500" }}>Company</p>
            <a href="#">About</a> <br />
          ...
          <div className="col footer">
            <p style={{ fontSize: "1.225rem", fontWeight: "500" }}>
              Quick links
            </p>
        ...
        <div className="d-flex justify-content-center align-items-center pb-3 footer-link">
